    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 px-6 py-3 grid grid-cols-12 gap-4">
                <div
                    class="col-span-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                    {{ __('Name') }}
                </div>
                <div
                    class="col-span-5 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                    {{ __('Description') }}
                </div>
                <div
                    class="col-span-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                ...
                <div
                    class="col-span-1 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                    {{ __('Actions') }}
                </div>
            </div>
                        ...
                        <div x-show="expanded" x-collapse x-cloak
                            ...
                            <form action="{{ route('departments.update', $department->id) }}" method="POST">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                    ...
                                    <div>
                                        <label for="department_lead_id_{{ $department->id }}"
                                            class="block text-sm font-medium text-gray-500 dark:text-gray-400">
                                            {{ __('Department Lead') }}
                                        </label>
                                    ...
                                    <div class="md:col-span-2">
                                        <label for="description_{{ $department->id }}"
                                            class="block text-sm font-medium text-gray-500 dark:text-gray-400">
                                            {{ __('Description') }}
                                        </label>
