<x-layouts.app>
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ __('Create Salary Log') }}</h1>
    </div>
                ...
                <div class="md:col-span-1">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700 flex justify-end">
                            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium">{{ __('Create Salary Log') }}</button>
                        </div>
                    </div>
                </div>
            </div>
